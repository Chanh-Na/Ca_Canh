...
import com.example.letrongtin.menunavigation.adapter.MachineAdapter;
...
public class MachinesAdFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        title.setText("Máy móc - Thiết bị");

        btnGo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                sendData.ChangFragment(5,"machines");
            }
        });
        return view;
    }
    ...
    private void GetMachines(){
        mDatabase.child("Machines").orderByKey().limitToFirst(3).addChildEventListener(new ChildEventListener() {
            @Override
