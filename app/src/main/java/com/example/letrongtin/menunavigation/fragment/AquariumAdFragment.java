...
public class AquariumAdFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btnGo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                sendData.ChangFragment(2,"aquariums");
            }
        });
        return view;
    }
    ...
    private void GetAquariums(){
        mDatabase.child("Aquariums").orderByKey().limitToFirst(3).addChildEventListener(new ChildEventListener() {
            @Override
