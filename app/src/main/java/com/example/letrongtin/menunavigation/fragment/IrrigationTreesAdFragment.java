...
public class IrrigationTreesAdFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        title.setText("Cây thủy sinh");

        btnGo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                sendData.ChangFragment(4,"irrigation trees");
            }
        });
        return view;
    }
    ...
    private void GetTrees(){
        mDatabase.child("IrrigationTrees").orderByKey().limitToFirst(3).addChildEventListener(new ChildEventListener() {
            @Override
